...
class Info(commands.Cog):
	...
	async def info_bot(self, ctx):
		...
		embed_info.add_field(name = "Memory Usage", value = f"{round(psutil.Process(os.getpid()).memory_info().rss / 1024 ** 2)}MB / {psutil.virtual_memory().available / 1024 ** 2}MB", inline = False)
